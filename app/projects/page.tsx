      ...
      <section className="py-24 bg-stone-50 min-h-150 flex items-center justify-center">
        <div className="container mx-auto px-6 flex justify-center">
          ...
          <motion.div 
            ...
            className="bg-white max-w-2xl w-full p-12 md:p-16 rounded-xl shadow-2xl text-center border border-slate-100"
          >
            <h2 className="text-4xl md:text-5xl font-bold text-slate-900 mb-6">
              Coming Soon
            </h2>
            <p className="text-slate-500 text-lg leading-relaxed mb-10 max-w-md mx-auto">
              Our first round of development projects will be published soon. Stay tuned for updates and exciting announcements from CHY Developments.
            </p>
            <Button variant="outlineDark" onClick={() => alert("Notification subscribed!")}>
              Notify Me
            </Button>
          </motion.div>
