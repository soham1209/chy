...
export const Button: React.FC<ButtonProps> = ({ children, variant = 'primary', className = '', onClick, icon, href }) => {
  ...
  const colors = {
    primary: "bg-red-700 text-white hover:bg-red-800 shadow-lg shadow-red-900/20 hover:-translate-y-1",
    ...
    ghost: "bg-transparent text-slate-900 hover:text-red-700 underline-offset-4 hover:underline p-0",
  };
