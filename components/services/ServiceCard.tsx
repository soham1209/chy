...
// Updated Map to include new icons if you use this card elsewhere
...
export const ServiceCard: React.FC<ServiceCardProps> = ({ service }) => {
  ...
  return (
    <div className="group relative bg-white border border-gray-200 p-8 transition-all duration-500 hover:shadow-2xl hover:-translate-y-2 hover:border-red-600/20 overflow-hidden h-full flex flex-col">
      ...
      <div className="w-16 h-16 bg-slate-50 text-slate-900 flex items-center justify-center mb-6 rounded-full group-hover:bg-red-700 group-hover:text-white transition-all duration-500 group-hover:scale-110 shadow-sm shrink-0">
      ...
      <p className="text-slate-600 text-sm leading-relaxed mb-6 border-b border-gray-100 pb-6 flex-grow">
        {service.desc}
      </p>
      
      {/* FIX: Only render the list if features exist and have items */}
